    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f7f1ff] via-[#fbf8ff] to-white pt-12 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="mt-12 rounded-2xl bg-white border border-[#ece5f9] shadow-[0_18px_50px_rgba(110,0,224,0.10)] grid grid-cols-2 md:grid-cols-5 divide-x divide-y md:divide-y-0 divide-[#f1ebfb] overflow-hidden"
        >
          {HERO_FEATURES.map((f) => (
